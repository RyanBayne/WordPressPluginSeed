 ...
 * WPSeed - Bar Chart
 *
 * A bar chart presentation with styling that suits the WordPress environment.
 * I have to apologise for not maintaining the original author and would gladly
 * update the information to point to the original class.  
 *
 * @author   Ryan Bayne
 * @category Interface
 * @package  WPSeed/WPSeed_BarChart
 * @since    1.0.0
 */
