 ...
 *
 * Cannot use wpseed_clean because it sometimes strips % chars and breaks the user's setting.
 *
 * @param  string $value
 * @return string
 */                                              
function wpseed_sanitize_permalink( $value ) {       
    global $wpdb;
 ...
 * @return string
 */
function wpseed_sanitize_tooltip( $var ) { 
