...
* @return boolean 
*/
function wpseed_is_extensionloaded( $giving_extension ){      
...
* @returns boolean
*/
function wpseed_is_decimalnumber( $img_url){       
...
* @returns boolean
*/
function wpseed_is_image_url( $img_url ){       
