...
if ( ! class_exists( 'WPSeed_Shortcode' ) ) :
       
abstract class WPSeed_Shortcode extends WPSeed_Codec_Instance {
    ...
    public function register ($key) {
        ...
        add_action('wpseed-shortcodes-shortcode_help', array($this, "add_shortcode_help"));
        add_filter('wpseed-shortcodes-shortcode_help-string', array($this, 'get_shortcode_help'));
    }
